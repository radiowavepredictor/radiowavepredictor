...
from function import make_pathloss_learning_dataset,predict_multiple_waves
...
def run_single_experiment(param):
    ...
    rnd = RandomState(0)
    dataset, val_dataset, scaler= make_pathloss_learning_dataset(simulation_cfg, rnn_cfg,rnd)
