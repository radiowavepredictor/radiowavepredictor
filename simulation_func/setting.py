...
###生成するフェージングデータに関する設定###
L = 50 # 多重波の数
DATA_NUM=10000 #一つのデータセットのデータ数
DELTA_D=0.005 #受信機が動く距離の最大値
...
DATA_SET_NUM = 50 #作成するデータセットの数(測定におけるコース数)
...
IN_FEATURES = 1
INPUT_LEN = 100
HIDDEN_NUMS = [32,16] #隠れ層のユニット数を配列で指定
OUT_STEPS_NUM = 1 
BATCH_SIZE = 256
EPOCHS = 100
LEARNING_RATE = 0.001
...
MODEL_PATH = path+f"../model/simulation/{USE_RNN_LAYER.__name__}_{INPUT_LEN}_"+"_".join(map(str, HIDDEN_NUMS))+".keras"
